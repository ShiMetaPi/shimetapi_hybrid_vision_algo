...
int main(int argc, char *argv[]) {
    ...
    Shimeta::Algorithm::Denoise::DoubleWindowFilter dwf_filter(36, 9, 1); // Using default parameters from header
    ...
    Metavision::Window window("Metavision SDK DWF Denoising", camera_width, camera_height,
    ...
    cam.cd().add_callback([&](const Metavision::EventCD *begin, const Metavision::EventCD *end) {
        ...
        denoised_events = dwf_filter.process_events(input_events);
